...
var ProjectedLayer = (function (_super) {
    ...
    ProjectedLayer.prototype.renderIntoContainer = function (child) {
        var map = this.props.map;
        if (this.props.type === 'marker') {
            var container = map.getCanvasContainer();
            return container ? react_dom_1.createPortal(child, container) : child;
        }
        return child;
    };
    ProjectedLayer.prototype.render = function () {
        ...
        return this.renderIntoContainer(React.createElement("div", { className: className + " " + anchorClassname, onClick: onClick, onDoubleClick: onDoubleClick, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave, onScroll: onScroll, onWheel: onWheel, style: finalStyle, ref: this.setContainer, tabIndex: tabIndex }, children));
    };
